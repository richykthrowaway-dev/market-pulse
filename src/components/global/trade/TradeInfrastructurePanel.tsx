...
const LAYERS: LayerOption[] = [
  ...
  { key: 'connectivity',   label: 'Connectivity',     icon: Network, color: '#22c55e', group: 'overlays', hint: 'UNCTAD LSCI per port. Seaports enlarge and tint along a green→amber gradient by their Liner Shipping Connectivity Index — top-tier hubs (Shanghai, Singapore) dominate; regional ports dim.' },
  { key: 'risk',           label: 'Risk / Disruption', icon: ShieldAlert, color: '#ef4444', group: 'overlays', hint: 'Derived risk score (0–10) per maritime chokepoint, computed from nearby conflicts (ACLED + GDELT), USGS earthquakes, and NASA EONET natural events. Auto-enables those feeds in the background — no extra clicks needed.' },
